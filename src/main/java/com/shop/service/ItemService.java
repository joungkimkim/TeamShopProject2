...
public class ItemService {
    ...
    @Transactional(readOnly = true)
    public Page<MainItemDto> getDisplayItemPage(ItemSearchDto itemSearchDto, Pageable pageable) {
        return itemRepository.getDisplayItemPage(itemSearchDto, pageable);
    }
}